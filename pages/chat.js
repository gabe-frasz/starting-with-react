...
const SUPABASE_ANON_KEY = process.env.NEXT_PUBLIC_SUPABASE_ANNON_KEY,
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="My first project with React" />
              ...
              <Box className="flex justify-between items-center">
                <Box className="flex items-center">
                  ...
                  <Box className="flex flex-col justify-center items-center md:flex-row">
                    <Text className="mr-2 text-slate-400">{el.from}</Text>
                ...
                <svg
                  ...
                  onClick={(event) => {
                    supabaseClient
                      ...
                      .match({
                        id: event.target.closest("li").getAttribute("datakey"),
                      })
                      .then(() => {
                        let arrFilter = msg.filter((li) => {
                          return (
                            li.id !=
                            Number(
                              event.target.closest("li").getAttribute("datakey")
                            )
                          );
                        });
